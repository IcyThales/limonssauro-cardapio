  ...
  return (
    <div className={`app-root ${dark ? "theme-dark" : ""}`}>
      <style>{`
        ...
        .app-root * { box-sizing: border-box; transition: background .16s ease, color .16s ease, border-color .16s ease, box-shadow .16s ease, transform .16s ease; }
        ...
        .modal-backdrop { position: fixed; inset: 0; background: var(--modal-bg); backdrop-filter: blur(5px); display: flex; align-items: flex-start; justify-content: center; padding: 40px 20px; overflow-y: auto; z-index: 50; }
