    ...
    <div className={`app-root ${dark ? "theme-dark" : ""}`}>
      <style>{`
        ...
        .app-root {
          ...
          --bg-a: #fbf3df;
          --bg-b: #d8ecec;
          --dot: rgba(38,57,60,0.05);
          --border-soft: rgba(38,57,60,0.18);
          --surface-tint: rgba(38,57,60,0.07);
          --pill-bg: rgba(255,255,255,0.55);
          --pill-ink: #24393c;
          --ghost-bg: rgba(255,255,255,0.7);
          --on-primary: #fffdf6;
          --on-lemon: #26393c;
          --card-shadow: rgba(38,57,60,0.16);
          --px-body: #ffcb3d;
          --px-rind: #c97f22;
          --px-hi: #fff1b8;
          --px-leaf: #6fa25a;
        ...
        .app-root.theme-dark {
          ...
          --surface-tint: rgba(255,255,255,0.09);
        ...
        .pixel-bg-deco { position: absolute; z-index: 0; pointer-events: none; }

        .wordmark {
          font-family: 'Fredoka', sans-serif; font-weight: 700; margin: 0; letter-spacing: 0.2px;
          color: var(--lemon);
        ...
        .tabs { display: flex; gap: 8px; background: var(--pill-bg); padding: 4px; border-radius: 999px; border: 1.5px solid var(--border-soft); }
        .tab-btn {
        ...
        .tab-btn-ativo { background: var(--lemon); color: var(--on-lemon); }
        ...
        .btn-primary { background: var(--sky-deep); color: var(--on-primary); }
        .btn-ghost { background: var(--ghost-bg); color: var(--ink); border: 1.5px solid var(--border-soft); }
        ...
        .content { max-width: 1040px; margin: 0 auto; padding: 8px 24px 60px; position: relative; z-index: 1; }

        .page-head { display: flex; align-items: flex-end; justify-content: space-between; flex-wrap: wrap; gap: 12px; margin-bottom: 22px; }
        .page-title { font-family: 'Fredoka', sans-serif; font-size: 24px; margin: 0 0 2px; color: var(--gold); display: flex; align-items: center; }
        ...
        .column-count { margin-left: auto; background: var(--surface-tint); font-size: 11px; font-weight: 800; padding: 2px 9px; border-radius: 999px; }
        ...
        .modal-backdrop { position: fixed; inset: 0; background: rgba(10,20,22,0.55); display: flex; align-items: flex-start; justify-content: center; padding: 40px 20px; overflow-y: auto; z-index: 50; }
        .auth-card { width: 100%; max-width: 360px; max-height: 85vh; overflow-y: auto; }
        .auth-icon { width: 38px; height: 38px; border-radius: 50%; background: var(--lemon); color: var(--on-lemon); display: flex; align-items: center; justify-content: center; margin: 0 auto 10px; border: 2.5px solid var(--gold); }
        .card-heading { font-family: 'Fredoka', sans-serif; font-size: 18px; margin: 0 0 4px; color: var(--ink); }
        ...
        .erro-msg { font-size: 12.5px; color: #7a1f18; font-weight: 800; background: #fbdede; border: 1.5px solid #e0a3a3; border-radius: 10px; padding: 8px 10px; }
      ...
      <PixelLemon size={90} opacity={0.12} style={{ position: "absolute", top: -10, right: "4%", transform: "rotate(12deg)", zIndex: 0 }} />
      <PixelLemon size={60} opacity={0.1} style={{ position: "absolute", top: "38%", left: "2%", transform: "rotate(-8deg)", zIndex: 0 }} />
      <PixelLemon size={70} opacity={0.1} style={{ position: "absolute", bottom: "6%", right: "8%", transform: "rotate(-14deg)", zIndex: 0 }} />
