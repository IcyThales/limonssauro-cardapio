    ...
    <div className={`app-root ${dark ? "theme-dark" : ""}`}>
      <style>{`
        ...
        .app-root.theme-dark {
          ...
          --pill-bg: rgba(0,0,0,0.22);
          --ghost-bg: rgba(255,255,255,0.08);
          --px-rind: #c97f22;
          --px-hi: #fff1b8;
        }
        .app-root.theme-dark .card { box-shadow: 0 6px 18px rgba(0,0,0,0.35); }
        .app-root.theme-dark .btn-primary { color: #16323b; }
        .app-root.theme-dark .tab-btn-ativo { color: #16323b; }
        ...
        .tabs { display: flex; gap: 8px; background: var(--pill-bg); padding: 4px; border-radius: 999px; }
        .tab-btn {
        ...
        .card {
          ...
          border-radius: 18px;
          box-shadow: 0 6px 16px rgba(38,57,60,0.14);
          padding: 16px;
          position: relative;
        }
